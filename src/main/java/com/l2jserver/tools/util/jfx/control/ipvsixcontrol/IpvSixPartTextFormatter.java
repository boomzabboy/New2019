 ...
 * @author HorridoJoho
 */
public class IpvSixPartTextFormatter extends TextFormatter<Integer>
{
	public IpvSixPartTextFormatter()
	{
		super(new ExIntegerStringConverter(0, 65535, 16), 0, new UnaryOperator<Change>()
		{
			private final Pattern r = Pattern.compile("^[\\da-fA-F]{1,4}$");
